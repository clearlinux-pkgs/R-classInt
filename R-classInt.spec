...
Version  : 0.4.11
Release  : 65
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/classInt_0.4-11.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/classInt_0.4-11.tar.gz
...
%setup -q -n classInt
pushd ..
cp -a classInt buildavx2
popd
pushd ..
cp -a classInt buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736378119
...
/usr/lib64/R/library/classInt/NEWS.md
...
/usr/lib64/R/library/classInt/tests/tinytest.R
/usr/lib64/R/library/classInt/tinytest/test_box.R
/usr/lib64/R/library/classInt/tinytest/test_largeN.R
/usr/lib64/R/library/classInt/tinytest/test_quantile_probs.R

%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/classInt/libs/classInt.so
/V4/usr/lib64/R/library/classInt/libs/classInt.so
