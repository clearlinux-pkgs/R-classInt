...
Source0  : https://cran.r-project.org/src/contrib/classInt_0.1-24.tar.gz
Summary  : Choose Univariate Class Intervals
Group    : Development/Tools
License  : GPL-2.0+
Requires: R-classInt-lib
Requires: R-e1071
...
export LANG=C
export SOURCE_DATE_EPOCH=1521300015
...
/usr/lib64/R/library/classInt/Meta/data.rds
...
/usr/lib64/R/library/classInt/data/jenks71.rda
